...
public class UserStepsController
{
    ...
    public void GoToStep(string questId, string state = UserQuestState.ACTIVE, int variantId = -1)
    {
        ...
        if (step.Type == QuestStepType.TRIGGER)
        {
            QuestTriggerStepData questTriggerStepStep = App.Data.QuestTriggerStep[step.TypeId];
        ...
        {
            QuestMessageData messageStep = App.Data.QuestMessageStep[step.TypeId];
    ...
    public void CompleteStep(string questId, int variantId)
    {
        ...
        StepData questStepData = App.Data.Steps[questId];
        if (questStepData.Type == QuestStepType.MESSAGE)
        {
            QuestMessageData messageStep = App.Data.QuestMessageStep[questStepData.TypeId];
