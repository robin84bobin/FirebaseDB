...
public class IPCyclerInspector : Editor {
	...
	void OnEnable () 
	{
		...
		_inverted = _cycler.FindProperty ( "inverted" );
	}
	...
	public override void OnInspectorGUI ()
	{
		...
		EditorGUILayout.BeginHorizontal ();
		EditorGUILayout.LabelField ( "Inverted", GUILayout.Width ( 150f ) );
		_inverted.boolValue = EditorGUILayout.Toggle ( _inverted.boolValue );
		EditorGUILayout.EndHorizontal ();
